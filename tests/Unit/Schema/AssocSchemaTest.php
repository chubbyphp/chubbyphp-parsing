...
final class AssocDemo implements \JsonSerializable
{
 ...
 * @internal
 */
final class AssocSchemaTest extends TestCase
{
    ...
    {
        try {
            new AssocSchema([new StringSchema()]);
    ...
    {
        try {
            new AssocSchema(['field1' => new StringSchema(), 'field2' => '', 'field3' => new IntSchema()]);
    ...
    public function testParseSuccessWithStrictIgnore(): void
    {
        ...
        $schema = (new AssocSchema(['field1' => new StringSchema()]))->strict(['field2']);
    ...
    public function testParseSuccessWithDefault(): void
    {
        ...
        $schema = (new AssocSchema(['field1' => new StringSchema(), 'field2' => new IntSchema()]))->default($input1);
    ...
    {
        $schema = (new AssocSchema(['field1' => new StringSchema(), 'field2' => new IntSchema()]))->nullable();
    ...
    public function testParseFailedWithFailedFields(): void
    {
        ...
        $schema = new AssocSchema(['field1' => new StringSchema(), 'field2' => new FloatSchema(), 'field3' => new IntSchema()]);
    ...
    public function testParseSuccessWithMissingNullableField(): void
    {
        ...
        self::assertSame(['field1' => 'test', 'field2' => null], $schema->parse(['field1' => 'test']));
    }
    ...
    public function testParseSuccessWithMissingFieldWithDefault(): void
    {
        ...
        self::assertSame(['field1' => 'test', 'field2' => 'default'], $schema->parse(['field1' => 'test']));
    }

    public function testParseFailedWithRequiredAndMissingField(): void
    {
        $schema = (new AssocSchema(['field1' => new StringSchema(), 'field2' => new StringSchema()]))
    ...
    {
        $schema = (new AssocSchema(['field1' => new StringSchema()]))->required(['field1']);
    ...
    public function testParseSuccessWithPreParse(): void
    {
        ...
        $schema = (new AssocSchema(['field1' => new StringSchema()]))->preParse(static fn () => $input);
    ...
    public function testParseSuccessWithPostParse(): void
    {
        ...
        $schema = (new AssocSchema(['field1' => new StringSchema()]))->postParse(static function (array $output) {
            $output['field2'] = 'test';

            return $output;
        });

        self::assertSame([...$input, 'field2' => 'test'], $schema->parse($input));
    }
    ...
    public function testGetFieldSchemaSuccess(): void
    {
        ...
        $schema = new AssocSchema(['field1' => new StringSchema(), 'field2' => $field2Schema]);
