...
final class AssocSchemaTest extends TestCase
{
    ...
    {
        $schema = (new AssocSchema(['field1' => new StringSchema()]))->optional(['field1'])->minProperties(1);
    ...
    {
        $schema = (new AssocSchema(['field1' => new StringSchema()]))->maxProperties(1);
