...
use Chubbyphp\Parsing\Schema\AbstractSchemaV2;
use PHPUnit\Framework\TestCase;

/**
 * @covers \Chubbyphp\Parsing\Schema\AbstractSchemaV2
 *
 * @internal
 */
final class AbstractSchemaV2Test extends TestCase
{
    public function testNullable(): void
    {
        $schema = new class extends AbstractSchemaV2 {
    ...
    {
        $successSchema = new class extends AbstractSchemaV2 {
            protected function innerParse(mixed $input): mixed
            {
                return $input;
            }
        ...
        $failSchema = new class extends AbstractSchemaV2 {
            protected function innerParse(mixed $input): mixed
            {
