...
final class JsonSchemaToCodeTest extends TestCase
{
    ...
    public static function provideJsonSchemaToParsingCodeCases(): iterable
    {
        ...
        yield 'string: format date-time' => [
            '{"type":"string","format":"date-time"}',
            '$schema = $p->string()->dateTime();',
        ];

        yield 'string: format duration' => [
            '{"type":"string","format":"duration"}',
            '$schema = $p->string()->duration();',
        ];
        ...
        yield 'string: format idn-email' => [
            '{"type":"string","format":"idn-email"}',
            '$schema = $p->string()->idnEmail();',
        ];

        yield 'string: format idn-hostname' => [
            '{"type":"string","format":"idn-hostname"}',
            '$schema = $p->string()->idnHostname();',
        ];

        yield 'string: format time' => [
            '{"type":"string","format":"time"}',
            '$schema = $p->string()->time();',
        ];
